...
class convNet(nn.Module):
    ...
    def __init__(self,resnet,myNet):
        ...
        self.resnet.bn1 = nn.BatchNorm2d(1)
    ...
    def forward(self, x):
        ...
        out = out.view(-1,36*1) #the 64 comes from the 2*growth rate term; 36 from ??
...
from random import *
import csv
dataPath = r'/mindhive/saxelab3/anzellotti/deepnet/expressions_identity/fer2013/fer2013/denseV2_32_500_k3_katietest/identity_transfer_data/holdout_happy_with45.csv'
...
newNet.train()
save_freq = 50
save_dir = '/mindhive/saxelab3/anzellotti/deepnet/expressions_identity/fer2013/fer2013/denseV2_32_500_k3_katietest_transfer_holdout_happy_LINEAR'
os.mkdir(save_dir)
loss_memory = []
