...
class convNet(nn.Module):
    ...
    def __init__(self,resnet,myNet):
        ...
        self.resnet.bn1 = nn.BatchNorm2d(160)
    ...
    def forward(self, x):
        ...
        out = self.resnet.dense1(out.float())
...
from random import *
import csv
dataPath = r'/mindhive/saxelab3/anzellotti/deepnet/expressions_identity/fer2013/fer2013/denseV2_32_500_k3_katietest/identity_transfer_data/holdout_surprised_with45.csv'
...
trainloader = DataLoader(karolinska_train_transformed, batch_size=16,
...
newNet.train()
save_freq = 50
save_dir = '/mindhive/saxelab3/anzellotti/deepnet/expressions_identity/fer2013/fer2013/denseV2_32_500_k3_katietest_transfer_holdout_surprised_DENSE1'
os.mkdir(save_dir)
loss_memory = []
...
testloader = DataLoader(karolinska_test_transformed, batch_size=16,
                        shuffle=True, num_workers=2,pin_memory=False)
