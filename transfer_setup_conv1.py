...
from random import *
import csv
dataPath = r'/mindhive/saxelab3/anzellotti/deepnet/expressions_identity/fer2013/fer2013/denseV2_32_500_k3_katietest/identity_transfer_data/holdout_disgusted_with45.csv'
...
newNet.train()
save_freq = 50
save_dir = '/mindhive/saxelab3/anzellotti/deepnet/expressions_identity/fer2013/fer2013/denseV2_32_500_k3_katietest_transfer_holdout_disgusted_CONV1'
os.mkdir(save_dir)
loss_memory = []
